// TODO: Rm when https://github.com/DefinitelyTyped/DefinitelyTyped/pull/22070 is merged
declare module 'parsimmon' {
   ...
   * ```
   */
  function Parsimmon<T>(fn: (input: string, i: number) => Parsimmon.Reply<T>): Parsimmon.Parser<T>;
